...
% ── Panel ────────────────────────────────────────────────
\node[panel,minimum width=18.5cm,minimum height=6.8cm,anchor=north west] at (-.3,7.2){};

% ── Title ────────────────────────────────────────────────
\node[font=\sffamily\bfseries\Large,align=center] at (8.9,6.15)
  {Condition D — U-Net entraîné sur images reconstruites par MedVAE};

% ── Pipeline ─────────────────────────────────────────────
\imagestack{inp}{(1.5,4.1)}
  {\includegraphics[width=2.2cm,height=2.2cm]{entrée.png}}

\node[modelfrozen] (medvae) at (5.5,4.1)
  {MedVAE\\{\scriptsize encode $\rightarrow$ decode}\\{\scriptsize \textit{gelé}}};

\imagestack{recon}{(9.3,4.1)}
  {\includegraphics[width=2.2cm,height=2.2cm]{entrée.png}}

\node[model] (unet) at (13.1,4.1)
  {U-Net\\{\scriptsize ResNet34 (ImageNet)}\\{\scriptsize \textit{entraînable}}};

\imagestack{out}{(16.9,4.1)}
...
% ── Dimension labels ─────────────────────────────────────
\node[dimtext] at (1.5,2.6)  {Angiographie X\\512 × 512 — 1 canal};
\node[dimtext] at (9.3,2.6)  {Image reconstruite\\512 × 512 — 1 canal};
\node[dimtext] at (16.9,2.6) {Masque prédit\\512 × 512 — 26 classes};

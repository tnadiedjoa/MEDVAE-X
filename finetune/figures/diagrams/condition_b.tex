...
% ── Title ────────────────────────────────────────────────
\node[font=\sffamily\bfseries\Large,align=center] at (8.9,6.85)
  {Condition B — MedVAE pré-entraîné (gelé) + tête de segmentation};

% ── Pipeline ─────────────────────────────────────────────
\imagestack{inp}{(1.5,4.4)}
  {\includegraphics[width=2.2cm,height=2.2cm]{entrée2.png}}

\node[modelfrozen] (enc) at (5.2,4.4)
  {MedVAE\\{\scriptsize encodeur}\\{\scriptsize \textit{gelé — HuggingFace}}};

\latentstack{lat}{(8.5,4.4)}
  {\includegraphics[width=1.4cm,height=1.4cm]{img_latent.png}}

\node[model] (head) at (11.8,4.4)
  {SegHead\\{\scriptsize 2× upsampling ×2}\\{\scriptsize \textit{entraînable}}};

\imagestack{out}{(15.5,4.4)}
...
% ── Dimension labels ─────────────────────────────────────
\node[dimtext] at (1.5,2.9)  {Angiographie X\\512 × 512 — 1 canal};
\node[dimtext] at (8.5,2.9)  {Espace latent\\128 × 128 — 1 canal};
\node[dimtext] at (15.5,2.9) {Masque prédit\\512 × 512 — 26 classes};

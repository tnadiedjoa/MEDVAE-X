...
\node[title] at (14.7,10.5) {Score de qualit\'e --- trois approches};

\node[data] (feat36) at (2.4,8.3) {36 features IQA};

\node[modelB] (pca) at (8.6,8.3) {StandardScaler + PCA\\PC1 (56\,\% var.)};
\node[modelB] (signB) at (14.6,8.3) {Correction signe\\+ MinMax};
...
\node[modelA] (loadings) at (8.6,5.3) {Loadings PC1\\$w_i=|\ell_i|/\sum|\ell_j|$};
\node[modelA] (combA) at (14.6,5.3) {Combinaison\\lin\'eaire};
...
\node[data] (feat512) at (2.4,2.0) {512 features ResNet\\+ d\'egradations synth.\\(cible $=1{-}$s\'ev\'erit\'e)};
